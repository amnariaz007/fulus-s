...
import {ADD_GOLD, DefaultStateType, getDispatchObject, REDUCE_ENERGY_LEFT} from "../../../../store/reducer";
...
const AutoclickButton: FC<AutoclickButtonProps> = ({}) => {
    ...
    return (
        <>
            {selector.autoclickEndTime !== null && selector.energyLeft !== null && selector.energyLeft > 0 && !hide && (
                <div
                    className="AutoclickButton--container"
                    onClick={start}
                >
                    <Img src={require("../../../../assets/images/emoji/robot.png")}/>
                </div>
            )}
        </>
    );
