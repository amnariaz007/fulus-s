...
import {ROUTE_GOLD_SWAP, ROUTE_WITHDRAWAL} from "../../routes";
        ...
        <Panel>
            ...
            <CellContainer>
                <Cell
                    ...
                    before={
                        <EmojiRectangle>
                            <Img src={require("../../assets/images/emoji/circular_vertical_arrows.png")} />
                        </EmojiRectangle>
                    }
                />
                ...
                {/*<Cell
                    ...
                    before={
                        <EmojiRectangle>
                            <Img src={require("../../assets/images/emoji/bank_card.png")} />
                        </EmojiRectangle>
                    }
                />*/}

                <Cell
                    onClick={() => navigate(ROUTE_WITHDRAWAL)}
                    title="Withdrawal USDT"
                    after={<Icon16Chevron />}
                    before={
                        <EmojiRectangle>
                            <Img src={require("../../assets/images/emoji/money_fly.png")} />
                        </EmojiRectangle>
                    }
                />
            </CellContainer>
